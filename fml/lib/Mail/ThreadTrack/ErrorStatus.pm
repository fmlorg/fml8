...
#
# $FML: Mail::ThreadTrack::ErrorStatus.pm,v 1.1 2001/04/08 13:25:37 fukachan Exp $
#

package Mail::ThreadTrack::ErrorStatus;
...
Mail::ThreadTrack::ErrorStatus - error handling component
...
Use this module in your C<Something> class module like this:
   ...
   package Something;
   use Mail::ThreadTrack::ErrorStatus qw(errstr error error_set error_clear);
...
Mail::ThreadTrack::ErrorStatus appeared in fml5 mailing list driver package.
