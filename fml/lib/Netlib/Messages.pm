...
Netlib::Messages -- message manipulators

=head1 SYNOPSIS

    my $m1 = new Netlib::Messages { content => \$body1 };

    my $m2 = new Netlib::Messages;
...
Netlib::Messages.pm appeared in fml5.
