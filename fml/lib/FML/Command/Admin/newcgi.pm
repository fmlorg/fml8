...
package FML::Command::Admin::newcgi;
use strict;
...
FML::Command::Admin::newcgi - set up cgi scripts for the specified domain.
...
sub process
{
	...
	# 2.3 XXX [main] generate CGI scripts for $ml_name@$ml_domain ML.
	use FML::ML::Control;
...
FML::Command::Admin::newcgi first appeared in fml8 mailing list driver package.
